...
namespace Brisk 
{
	void DescriptorLayoutVulkan::Init() {
        ...
        if (vkCreateDescriptorSetLayout(Engine::s_Application->GetGpuAdapter()->GetDevice<GpuAdapterVulkan>()->GetDevice(), &layoutInfo, nullptr, &m_DescriptorLayout) != VK_SUCCESS) {
