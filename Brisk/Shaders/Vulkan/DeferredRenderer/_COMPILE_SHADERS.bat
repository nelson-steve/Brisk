...
@REM echo Compiling ShadowMapPass.vert...
@REM glslc ShadowMapPass.vert -o Compiled/ShadowMapPassVS.spv || goto :error

@REM echo Compiling ShadowMapPass.frag...
@REM glslc ShadowMapPass.frag -o Compiled/ShadowMapPassFS.spv || goto :error
