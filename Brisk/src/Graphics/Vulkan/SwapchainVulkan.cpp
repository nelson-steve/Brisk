...
namespace Brisk 
{
	void SwapchainVulkan::Release() {
		for (auto imageView : m_SwapchainImageViews) {
			vkDestroyImageView(std::static_pointer_cast<GpuAdapterVulkan>(Application::GetGpuAdapter())->GetDevice(), imageView, nullptr);
		}
		vkDestroySwapchainKHR(std::static_pointer_cast<GpuAdapterVulkan>(Application::GetGpuAdapter())->GetDevice(), m_Swapchain, nullptr);
	}
	...
	void SwapchainVulkan::Create(Mode mode) {
		...
		vkGetPhysicalDeviceSurfaceCapabilitiesKHR(std::static_pointer_cast<GpuAdapterVulkan>(Application::GetGpuAdapter())->GetPhysicalDevice(), std::static_pointer_cast<GpuAdapterVulkan>(Application::GetGpuAdapter())->GetSurface()->GetRef(), &surfaceCapabilities);
		uint32_t formatCount;
		vkGetPhysicalDeviceSurfaceFormatsKHR(std::static_pointer_cast<GpuAdapterVulkan>(Application::GetGpuAdapter())->GetPhysicalDevice(), std::static_pointer_cast<GpuAdapterVulkan>(Application::GetGpuAdapter())->GetSurface()->GetRef(), &formatCount, nullptr);
		std::vector<VkSurfaceFormatKHR> supportedFormats;
		if (formatCount != 0) {
			supportedFormats.resize(formatCount);
			vkGetPhysicalDeviceSurfaceFormatsKHR(std::static_pointer_cast<GpuAdapterVulkan>(Application::GetGpuAdapter())->GetPhysicalDevice(), std::static_pointer_cast<GpuAdapterVulkan>(Application::GetGpuAdapter())->GetSurface()->GetRef(), &formatCount, supportedFormats.data());
		}
		uint32_t presentModeCount;
		vkGetPhysicalDeviceSurfacePresentModesKHR(std::static_pointer_cast<GpuAdapterVulkan>(Application::GetGpuAdapter())->GetPhysicalDevice(), std::static_pointer_cast<GpuAdapterVulkan>(Application::GetGpuAdapter())->GetSurface()->GetRef(), &presentModeCount, nullptr);

		std::vector<VkPresentModeKHR> presentModes;
		if (presentModeCount != 0) {
			presentModes.resize(presentModeCount);
			vkGetPhysicalDeviceSurfacePresentModesKHR(std::static_pointer_cast<GpuAdapterVulkan>(Application::GetGpuAdapter())->GetPhysicalDevice(), std::static_pointer_cast<GpuAdapterVulkan>(Application::GetGpuAdapter())->GetSurface()->GetRef(), &presentModeCount, presentModes.data());
		}
		...
		vkGetPhysicalDeviceQueueFamilyProperties(std::static_pointer_cast<GpuAdapterVulkan>(Application::GetGpuAdapter())->GetPhysicalDevice(), &queueFamilyCount, nullptr);

		std::vector<VkQueueFamilyProperties> queueFamilies(queueFamilyCount);
		vkGetPhysicalDeviceQueueFamilyProperties(std::static_pointer_cast<GpuAdapterVulkan>(Application::GetGpuAdapter())->GetPhysicalDevice(), &queueFamilyCount, queueFamilies.data());
		...
		VK_LOG(vkCreateSwapchainKHR(std::static_pointer_cast<GpuAdapterVulkan>(Application::GetGpuAdapter())->GetDevice(), &swapChainCreateInfo, nullptr, &m_Swapchain));
		...
		for (size_t i = 0; i < m_SwapchainImages.size(); i++) {
			...
			if (vkCreateImageView(std::static_pointer_cast<GpuAdapterVulkan>(Application::GetGpuAdapter())->GetDevice(), &image_views_create_info, nullptr, &m_SwapchainImageViews[i]) != VK_SUCCESS) {
