...
echo Compiling QuadRender.vert...
glslc QuadRenderPass.vert -o Compiled/QuadRenderPassVS.spv || goto :error

echo Compiling LightingPass.frag...
glslc LightingPass.frag -o Compiled/LightingPassFS.spv || goto :error

echo Compiling TonemappingPass.frag...
glslc TonemappingPass.frag -o Compiled/TonemappingPassFS.spv || goto :error

echo Compiling ForwardPass.mesh...
glslc ForwardPass.mesh -o Compiled/ForwardPassMS.spv  --target-env=vulkan1.3 || goto :error
...
echo Compiling BloomBlurVPass.frag...
glslc BloomBlurVPass.frag -o Compiled/BloomBlurVPassFS.spv || goto :error

echo Compiling BloomBlurHPass.frag...
glslc BloomBlurHPass.frag -o Compiled/BloomBlurHPassFS.spv || goto :error
